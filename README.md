...
We will not be testing the framework defined functions such as save , update ,delete . We are checking if the user defined funstions are generating the correct output   
or not
